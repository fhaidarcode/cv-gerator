...
<body>
    ...
    <div class="dados">
        ...
        <label>Data de Nascimento:</label> <?php echo $_POST['dia'] . '/' . $_POST['mes'] . '/' . $_POST['ano']; ?><br>
    ...
    <script>
        // A função window.print() é usada para acionar a impressão quando a página é carregada
